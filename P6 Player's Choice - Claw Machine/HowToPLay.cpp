...
void HowToPlay::Render(ShaderProgram* program) {
    ...
    Util::DrawText(program, Util::LoadTexture("font2.png"), "Down: Descend", .5f, .0002f, glm::vec3(-3.65, 1, 0));
    Util::DrawText(program, Util::LoadTexture("font2.png"), "Space: Drop coin", .5f, .0002f, glm::vec3(-3.65, 0, 0));
    Util::DrawText(program, Util::LoadTexture("font2.png"), "If you hit an enemy, drop coin + return to start", .15f, .0002f, glm::vec3(-3.65, 0, 0));
