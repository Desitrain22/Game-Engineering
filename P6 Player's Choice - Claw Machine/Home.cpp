...
void Home::Render(ShaderProgram* program) {
    ...
    Util::DrawText(program, Util::LoadTexture("font2.png"), "The Claw! Get the coins", .25f, .0002f, glm::vec3(-3.65, 2, 0));
    Util::DrawText(program, Util::LoadTexture("font2.png"), "Bring the coins to the gate", .25f, .0002f, glm::vec3(-3.65, 1.5, 0));
    Util::DrawText(program, Util::LoadTexture("font2.png"), "<- -> to move; Hold Down to descend", .25f, .0002f, glm::vec3(-3.65, 1.0, 0));
    Util::DrawText(program, Util::LoadTexture("font2.png"), "Start: Enter", .15f, .0002f, glm::vec3(-3.65, 0.5, 0));
}